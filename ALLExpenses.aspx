<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ALLExpenses.aspx.cs" Inherits="ExpenseTrackerWeb.ALLExpenses" %>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="Admin.aspx">ALL Users</a></li>
            <li class="active"><a href="ALLExpenses.aspx">ALL Expenses</a></li>
        <%--
